...
//         $user = Files::updateUserImage($request, $user, 'user-uploads/profile', 'profile_image', 'default.jpg');
        
//         // Update cover image
//         $user = Files::updateUserImage($request, $user, 'user-uploads/cover', 'cover_image', 'cover-default.jpg');
